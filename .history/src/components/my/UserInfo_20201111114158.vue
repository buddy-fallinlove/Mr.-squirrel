...
<div>
    ...
    <div class="user-top">
        ...
        <div>
            <img v-if="nickname === 'guest'" src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=4187538616,1757466218&fm=26&gp=0.jpg" alt="" class="icon" />
            <img src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=17998502,2059064728&fm=15&gp=0.jpg" alt="" class="icon" />
        </div>
        <div v-if="nickname==='guest'" @click="$goto('/login')">登录/注册</div>
        <div v-else class="user">
            <div>欢迎您, {{nickname}}</div>
            <div @click="outline"></div>
        </div>
    </div>
</div>
</template>
