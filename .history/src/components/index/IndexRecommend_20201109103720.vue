...
<div class="container">
    ...
    <div class="wrapperX recommend-group" :className="'.wrapperX'" :scrollX="true" :scrollY="false" :click="false">
        <recommend-box class="recommend-box" v-for="item in recommendData" :key="item.id" :item="item" />
    </div>
</div>
</template>
